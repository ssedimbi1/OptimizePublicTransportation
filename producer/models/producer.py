...
class Producer:
    ...
    def __init__(
        ...
        self.producer = AvroProducer(broker_properties, default_key_schema=key_schema, default_value_schema=value_schema)
    ...
    def create_topic(self):
        ...
        if self.topic_exists() is True:
            ...
            newTopics = [NewTopic(topic=self.topic_name, num_partitions=self.num_partitions, replication_factor=self.num_replicas)]
